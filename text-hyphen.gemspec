...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["History.rdoc", "License.rdoc", "Manifest.txt", "README.rdoc", "License.rdoc", "History.rdoc", "README.rdoc"]
  ...
  s.test_files = ["test/test_text_hyphen.rb", "test/test_bugs.rb"]
